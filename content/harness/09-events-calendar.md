...
You can also ask about events for a specific day — it knows how to work with your calendar.

Additionally, when you ask a question, we attach a few upcoming events to the AI model's context so it can use that information to give you better results.
